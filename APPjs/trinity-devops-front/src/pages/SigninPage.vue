            ...
            <div
                ...
                <div
                    ...
                    <div class="text-center sm:mx-auto sm:w-full sm:max-w-sm">
                        <h2 class="text-3xl font-bold tracking-tight text-black sm:text-3xl">Créer un compte</h2>
                    </div>
                    <div class="mt-6 sm:mx-auto sm:w-full sm:max-w-sm">
                        <form @submit.prevent="register" class="space-y-6">
                            ...
                            <div>
                                <label for="confirm-password" class="block text-sm font-medium text-gray-900">Confirmer
                                    le mot de passe</label>
                                <div class="mt-2">
                                    <input v-model="confirmPassword" type="password" name="confirm-password"
                                        id="confirm-password" autocomplete="new-password" required
                                        class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 outline-gray-300 placeholder:text-gray-400 sm:text-sm" />
                                </div>
                            </div>
